...
### Decision 6：焚香中途操作——點擊香體互動
**選擇**：點擊香體切換熄滅/重燃，搭配 tooltip 提示

**理由**：
- 模擬現實中用手熄香或重新點燃的直覺操作，比按鈕更自然
- tooltip 提供操作引導，降低探索成本
- 「跳過，繼續儀式」保留為按鈕，因為它是流程導航而非對香的操作
- 熄滅後可重燃（根據剩餘長度重算計時），符合現實行為
